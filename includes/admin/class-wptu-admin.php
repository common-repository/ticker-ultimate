...
class Wptu_Admin {
	...
	function wptu_register_menu() {
		...
		add_submenu_page( 'edit.php?post_type='.WPTU_POST_TYPE, __( 'Upgrade To Pro  - Ticker Ultimate', 'ticker-ultimate' ), '<span style="color:#ff2700">'.__( 'Upgrade To Pro - Try Pro For 5 Days Free', 'ticker-ultimate' ).'</span>', 'manage_options', 'wptu-premium', array( $this, 'wptu_premium_page' ));
	}
